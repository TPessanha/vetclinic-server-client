...
//        val adminMock : Pet = mock(Pet::class.java)
//        `when`(adminMock.appointments).thenReturn(emptyList())
        ...
        assertNotEquals(admin03.email, admin3.email)
        assertNotEquals(admin03.username, admin3.username)
